...
.grad{
background-image: linear-gradient(to bottom right, skyblue,grey,skyblue);
...
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/15.jpg');
	background-size: 100%;
	padding-top: 75px;
	background-repeat: no repeat;
					...
					<div class="card input-group-addon grad">
						<div class="card-body">
							<%
								...
								if (id>0) {
							%>
							<h3 class="text-center default-text text-black">Update
								Marksheet</h3>
							<%
								} else {
							%>
