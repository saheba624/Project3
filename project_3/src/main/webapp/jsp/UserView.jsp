...
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/13.jpg');
	background-size: 100%;
	padding-top: 70px
...
<body class="hm">
	...
	<div>
					...
					<div class="card input-group-addon">
						<div class="card-body" style="background: beige">
							...
							<div>
								...
								<input type="hidden" name="createdBy" value="null"> <input type="hidden" name="modifiedBy" value="null"> <input type="hidden" name="createdDatetime" value="0">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="firstName" placeholder="First Name" value="" fdprocessedid="xc4fu7">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> </font><br>			
    ...
    <div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="lastName" placeholder="Last Name" value="" fdprocessedid="71w6gp">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> </font><br>		
    ...
    <div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="password" class="form-control" name="password" placeholder="password" value="" fdprocessedid="lmeh">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> </font><br>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="password" class="form-control" name="confirmPassword" placeholder="confirmPassword" value="" fdprocessedid="stzjbq">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> </font><br>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="defaultForm-email" name="emailId" placeholder="email Id" value="" fdprocessedid="mw5scy">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> </font><br>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="defaultForm-email" maxlength="10" name="mobileNo" placeholder="mobile No" value="" fdprocessedid="6t9aps">
      </div>
    </div>							
	<font color="red" class="pl-sm-5"> </font><br>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <select class="form-control" style="border: 2px solid #8080803b;" name="role" fdprocessedid="sdsvbt"><option class="dropdown-item" style="border: 2px solid #8080803b;" selected="" value="">------Select a role---------</option><option value="1">Admin</option><option value="4">College</option><option value="3">Faculty</option><option value="5">Kiosk</option><option value="2">Student</option></select>
      </div>
    </div>							
	<font color="red" class="pl-sm-5"> </font><br>							
      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text"><i class="fa fa-venus-mars grey-text" style="font-size: 1rem;"></i> </div>
									...
									<select class="form-control" name="gender" fdprocessedid="cnb2rs"><option class="dropdown-item" selected="" value="">------Select a gender--------</option><option value="Male">Male</option><option value="Female">Female</option></select></div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="udate" name="dob" class="form-control hasDatepicker" placeholder="Date Of Birth" readonly="readonly" value="" fdprocessedid="lvu7sx">
      </div>
    </div>	
	<font color="red" class="pl-sm-5"> </font><br>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation" class="btn btn-success btn-md" style="font-size: 17px" value="Save" fdprocessedid="i4zix"> <input type="submit" name="operation" class="btn btn-warning btn-md" style="font-size: 17px" value="Reset" fdprocessedid="wq3qcc">
							</div>
